...
encuentra ordenado por sucursal y contiene la siguiente estructura:
 ...
 �  Sucursal (15 caracteres m�ximo)     //ORDENADO
...
pasado con la siguiente estructura:
 ...
 �  C�digo de producto (entero)
 �  Descripci�n (20 caracteres m�ximo)
 �  Precio (float)
 �  Stock (entero)
 �  Punto de pedido (entero)
 �  Cantidad para pedido (entero)

No se sabe la cantidad exacta de productos pero s� se sabe que no hay m�s de 200. Se desea:

 a.  Mostrar el total vendido en cada sucursal.
 b.  Mostrar la recaudaci�n total de la empresa en el mes.
 c.  Determinar la sucursal que vendi� mayor cantidad de productos.
 d.  Actualizar el archivo de productos con el nuevo stock.
 e.  Realizar un archivo llamado pedidos.dat que incluya aquellos productos que deben solicitarse (c�digo y cantidad) de
